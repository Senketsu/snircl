...
sniDB = open(connection = ":memory:","","","")
 # sniDB : TDbConn = open(connection = "/home/senketsu/SQ.db","","","")
...
proc printEvent (msg: string) =
 if bColorOut:
  if msg.startsWith("***Error"):
   stderr.writeln("\27[1;31m$1\27[0m"%[msg])
  elif msg.startsWith("*Notice") :
   stderr.writeln("\27[1;34m$1\27[0m"%[msg])
  elif msg.startsWith("**Warning") :
   stderr.writeln("\27[1;33m$1\27[0m"%[msg])
  elif msg.startsWith("*Debug") :
   stderr.writeln("\27[1;32m$1\27[0m"%[msg])
  else:
   stderr.writeln(msg)
 else:
  stderr.writeln(msg)
...
proc printEventMsg* (irc: PIrc) =
 ...
 if bColorOut:
  ...
  of MJoin: # \27[1;35m \27[0m - BG \27[Xm
   stdout.writeln("\27[0;35m* $1($2) has joined $3\27[0m"%[irc.data.nick,irc.data.source,irc.data.target])
  of MPart:
   stdout.writeln("\27[0;35m* $1 has parted ($2)\27[0m"%[irc.data.nick,irc.data.target])
  of MMode:
   stdout.writeln("\27[46m* $1 has changed mode of $2[$3] ($4)\27[0m"%[irc.data.nick,irc.data.params[high(irc.data.params)],irc.data.target,irc.data.params[1]])
  of MTopic:
   stdout.writeln("\27[43m* $1 has changed the topic of $2 to: $3\27[0m"%[irc.data.nick,irc.data.target,irc.data.msg])
  of MKick:
   stdout.writeln("\27[41m* $1 has kicked $2 from $3($4)\27[0m"%[irc.data.nick,irc.data.params[1],irc.data.target,irc.data.msg])
  of MQuit:
   stdout.writeln("\27[1;35m* $1 has quit ($2)\27[0m"%[irc.data.nick,irc.data.target])
  of MNotice:
   stdout.writeln("\27[1;34m$1 [$2] $3: $4\27[0m"%[irc.data.tStampS,irc.data.target,irc.data.nick,irc.data.msg])
  of MPrivMsg:
   if irc.data.target == irc.nickName:
    stdout.writeln("\27[1;32m$1 [$2] $3: $4\27[0m"%[irc.data.tStampS,irc.data.target,irc.data.nick,irc.data.msg])
   else:
    stdout.writeln("$1 [$2] $3: $4"%[irc.data.tStampS,irc.data.target,irc.data.nick,irc.data.msg])
  else: discard
 else:
  case irc.data.cmd
  of MJoin: # \27[1;35m \27[0m
   stdout.writeln("* $1($2) has joined $3"%[irc.data.nick,irc.data.source,irc.data.target])
  of MPart:
   stdout.writeln("* $1 has parted ($2)"%[irc.data.nick,irc.data.target])
  of MMode:
   stdout.writeln("* $1 has changed mode of $2[$3] ($4)"%[irc.data.nick,irc.data.params[high(irc.data.params)],irc.data.target,irc.data.params[1]])
  of MTopic:
   stdout.writeln("* $1 has changed the topic of $2 to: $3"%[irc.data.nick,irc.data.target,irc.data.msg])
  of MKick:
   stdout.writeln("* $1 has kicked $2 from $3($4)"%[irc.data.nick,irc.data.params[1],irc.data.target,irc.data.msg])
  of MQuit:
   stdout.writeln("* $1 has quit ($2)"%[irc.data.nick,irc.data.target])
  of MNotice:
   stdout.writeln("$1 ->[$2]<- $3: $4"%[irc.data.tStampS,irc.data.target,irc.data.nick,irc.data.msg])
  of MPrivMsg:
   if irc.data.target == irc.nickName:
